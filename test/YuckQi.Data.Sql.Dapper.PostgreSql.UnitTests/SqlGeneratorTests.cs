...
namespace YuckQi.Data.Sql.Dapper.PostgreSql.UnitTests;
...
public class SqlGeneratorTests
{
    ...
    public void GenerateCountQuery_WithSingleParameter_IsValid()
    {
        ...
        Assert.That(sql, Is.EqualTo("select count(*) from \"public\".\"SurLaTable\" where (\"Id\" = @Id);"));
    }
    ...
    public void GenerateGetQuery_WithSingleParameter_IsValid()
    {
        ...
        Assert.That(sql, Is.EqualTo("select \"Id\", \"Name\" from \"public\".\"SurLaTable\" where (\"Id\" = @Id);"));
    }
    ...
    public void GenerateSearchQuery_WithSingleParameter_IsValid()
    {
        ...
        Assert.That(sql, Is.EqualTo("select \"Id\", \"Name\" from \"public\".\"SurLaTable\" where (\"Name\" = @Name) order by \"Name\" desc limit 50 offset 50;"));
    }
    ...
    public void GenerateGetQuery_WithEqualOperation_IsValid()
    {
        ...
        Assert.That(sql, Is.EqualTo("select \"Id\", \"Name\" from \"public\".\"SurLaTable\" where (\"Name\" = @Name);"));
    }
    ...
    public void GenerateGetQuery_WithEqualOperation_AndNullValue_IsValid()
    {
        ...
        Assert.That(sql, Is.EqualTo("select \"Id\", \"Name\" from \"public\".\"SurLaTable\" where (\"Name\" is null);"));
    }
    ...
    public void GenerateGetQuery_WithNotEqualOperation_AndNullValue_IsValid()
    {
        ...
        Assert.That(sql, Is.EqualTo("select \"Id\", \"Name\" from \"public\".\"SurLaTable\" where (\"Name\" is not null);"));
    }
    ...
    public void GenerateGetQuery_WithInOperation_IsValid()
    {
        ...
        Assert.That(sql, Is.EqualTo("select \"Id\", \"Name\" from \"public\".\"SurLaTable\" where (\"Name\" in (@Name0,@Name1,@Name2,@Name3));"));
    }
    ...
    public void GenerateGetQuery_WithInOperation_AndEmptySet_IsValid()
    {
        ...
        Assert.That(sql, Is.EqualTo("select \"Id\", \"Name\" from \"public\".\"SurLaTable\" where (\"Name\" in (null));"));
    }
