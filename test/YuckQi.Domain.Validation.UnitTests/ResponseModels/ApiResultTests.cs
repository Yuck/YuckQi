...
public class ApiResultTests
{
    ...
    {
        var content = 42;
        var result = new ApiResult<Int32> { Content = content };
    ...
    {
        var a = new ApiResult<Int32> { Content = 1 };
        var b = new ApiResult<Int32> { Content = 1 };
    ...
    {
        var original = new ApiResult<Int32> { Content = 42 };
    ...
    {
        var result = new ApiResult<Int32> { Content = 5 };
