...
namespace YuckQi.Data.Sql.Dapper.PostgreSql.Internal;

internal sealed class DbTypeMap(IDictionary<Type, DbType> dictionary) : ReadOnlyDictionary<Type, DbType>(dictionary)
{
